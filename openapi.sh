...
awk -v UMAMI_ID="$(. ./.env; printf %s "$UMAMI_ID")" 'NR==11{print "  <script defer src=\"https://stat.faizath.com/script.js\" data-website-id=\"" UMAMI_ID "\"></script>"}1' app/templates/pages/index.html > temp.html && mv temp.html app/templates/pages/index.html